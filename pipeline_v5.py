...
for pid in sample_pools:
    result = prescribe_visit(
        pid, df_master,
        models_dict['visit_timing'], models_dict['ph'], models_dict['chlorine'], models_dict['turbidity'],
        preprocessor, fill_values, all_numeric_features, categorical_features,
        model_chlorine_clf=models_dict.get('chlorine_clf'),
...
expected_files = {
    ...
    'best_visit_timing.pkl': MODELS_DIR,
    'best_ph.pkl': MODELS_DIR,
    'best_chlorine.pkl': MODELS_DIR,
    'best_turbidity.pkl': MODELS_DIR,
